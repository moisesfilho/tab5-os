...
/*
 * NOTA (2026-08-13): tabela de init do painel ST7121/ST7123 conforme o driver
 * oficial espressif/esp_lcd_st7121 (esp-iot-solution) e o firmware M5Tab5-UserDemo.
 * O BSP v1.2.0 usava uma tabela errada (0x71 0x23 sem 0x78/0x79/0xA5 e SLPOUT
 * sem delay) que deixava o painel todo preto. Para PoC, a tabela abaixo é
 * patcheada diretamente no managed_components.
 */
static const st7123_lcd_init_cmd_t disp_init_data_st7123[] = {
    ...
    {0x11, NULL, 0, 120},  /* SLPOUT: >120ms antes do DISPON */
