...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    const esp_lcd_dpi_panel_config_t dpi_config_st7123 = {
        ...
        .video_timing =
        {
            ...
            .hsync_pulse_width = 2,
            .hsync_front_porch = 40,
            /* Timing do painel ST7121 (fabricante M5Tab5-UserDemo):
             * vsync pulse=20, back=24, front=200. O v1.2.0 usava valores
             * do ST7123 (2/8/220), o que deslocava a janela ativa alguns
             * pixels (visivel na paisagem). */
            .vsync_back_porch  = 24,
