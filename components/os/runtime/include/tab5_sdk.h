...
/* Export macros for Wasm/Native modules */
...
/** Copia o texto para buffer do caller; retorna tamanho necessário ou erro. */
...
/**
 * @brief Define se o texto de um Label deve ser quebrado em múltiplas linhas.
 */
